...
fr: bightml
	...
	minify $(FINAL_DIR)/commentaire.big.html > $(FINAL_DIR)/commentaire.html
...
bightml:
	...
	mustache $(TEMPLATES_DIR)/common.json $(TEMPLATES_DIR)/commentaire.mustache > $(FINAL_DIR)/commentaire.big.html
